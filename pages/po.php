...
<body>
    ...
    <main>
        <h1 style="margin-bottom:40px">PO</h1>
...
<th onclick="sortByColumn(17)">MIN</th>
                        ...
                        <?php
// Compter le nombre de lignes qui correspondent à la condition 'EURO U20'
$euroU20RowCount = 0; 
foreach ($donnees as $row) {
    if ($row['CHAMPIONNAT'] == 'EURO U20 PO' || $row['CHAMPIONNAT'] == 'CDF' || $row['CHAMPIONNAT'] == 'CDFU18' || $row['CHAMPIONNAT'] == 'LFB PO') {
        $euroU20RowCount++;
    }
}
?>
...
for ($i = count($donnees) - 1; $i >= 0; $i--):
    $row = $donnees[$i];
    // Vérifier si le championnat est 'EURO U20'
    if ($row['CHAMPIONNAT'] == 'EURO U20 PO' or $row['CHAMPIONNAT'] == 'CDF' or $row['CHAMPIONNAT'] == 'CDFU18' or $row['CHAMPIONNAT'] == 'LFB PO'):
?>
 <tr>
